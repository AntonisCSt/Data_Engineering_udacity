...
songplays (songplay_id SERIAL PRIMARY KEY, start_time time NOT NULL, user_id int , level varchar, song_id varchar, artist_id varchar, session_id int, location varchar, user_agent text);""")
...
""")
#I understand that we will not have conflicts because 
...
song_select = (""" SELECT songs.song_id, artists.artist_id 
                   FROM songs
                   INNER JOIN artists ON songs.artist_id = artists.artist_id WHERE songs.title = %s and artists.name = %s and songs.duration = %s
""")
